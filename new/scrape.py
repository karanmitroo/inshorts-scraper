...
url = "https://www.inshorts.com/en/read/automobile"
...
while (True):
    ...
    request = requests.post(url, data={'news_offset' : min_news_id , 'category' : 'automobile'})
    ...
    """
    with open('min_news_id_automobile.txt', 'aw') as min_news_id_file:
